...
const projects = [
  { n:"01", title:"GIFT HUB", category:"Full-Stack E-Commerce", featured:true, tone:"gift", description:"A complete gift-store experience built for effortless discovery, personalisation and checkout.", tech:["React","TypeScript","Cloudflare"], github:"https://github.com/SGKavishka/Gift-Hub", features:["Product search & filters","Wishlist and shopping cart","Custom gift-box builder","Budget controls","Order tracking","WhatsApp ordering"] },
  { n:"02", title:"Velocity Legends", category:"Unity C# Racing Game", featured:true, tone:"race", description:"A systems-rich racing game with custom vehicle physics, progression and configurable mechanics.", tech:["Unity","C#","JSON"], github:"https://github.com/SGKavishka/Car-Game", features:["Wheel-collider physics","Drifting & nitro boost","Race states & lap timing","Vehicle selection","Unlockable upgrades","JSON save system"] },
  { n:"03", title:"TechGear", category:"Technology Products Website", tone:"tech", description:"Responsive product website with database-driven inventory management and complete CRUD operations.", tech:["PHP","MySQL","JavaScript"], github:"https://github.com/SGKavishka/TechGear", features:["Product browsing","Database listings","Create, read, update & delete","Responsive interface"] },
  { n:"04", title:"TeachMe", category:"Online Learning Platform", tone:"learn", description:"An interactive learning platform designed to make digital education simple and engaging.", tech:["HTML","CSS","PHP","MySQL"], github:"https://github.com/SGKavishka/TeachMe", features:["Interactive frontend","Engagement features","Backend data management","Database integration"] },
  { n:"05", title:"Library Management", category:"Web Application", tone:"library", description:"A secure library solution for managing books, members, borrowing and return operations.", tech:["Web App","MySQL","CRUD"], features:["Book & member management","Borrowing workflow","Availability tracking","Secure data retrieval"] },
  { n:"06", title:"ProxJavaSwingApp", category:"Java Desktop Application", tone:"java", description:"A clean desktop application built around object-oriented principles and practical CRUD workflows.", tech:["Java","Swing","OOP"], features:["Desktop GUI","CRUD operations","Object-oriented architecture","User-friendly interface"] },
  { n:"07", title:"Tourism Web App", category:"Collaborative Team Project", tone:"travel", description:"A responsive tourism promotion experience designed and developed collaboratively.", tech:["Frontend","Responsive","UX"], features:["Interface design","Frontend development","Responsive design","Navigation & UX improvements"] },
];
...
function ProjectCard({p}:{p:(typeof projects)[number]}) {
  return <article className={`project-card reveal ${p.featured ? "featured" : ""}`}>
    <div className={`project-art ${p.tone}`}>
      ...
      {p.tone==="gift" && <div className="mock-store"><div className="mock-logo">GIFT<span>HUB</span></div><div className="mock-copy"><small>Made for their</small><b>BEST MOMENTS.</b></div><div className="gift-box">✦</div></div>}
      {p.tone==="race" && <div className="mock-race"><div className="road"/><div className="speed">247<small> KM/H</small></div><div className="car">◆</div><b>VELOCITY<br/><span>LEGENDS</span></b></div>}
      {!p.featured && <div className="project-glyph">{p.tone==="tech"?"⌁":p.tone==="learn"?"A+":p.tone==="library"?"▤":p.tone==="java"?"J": "⌖"}</div>}
    </div>
